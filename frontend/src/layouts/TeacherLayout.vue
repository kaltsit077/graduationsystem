    ...
    <el-container>
      <el-aside :width="asideWidth" class="layout-aside" :class="{ collapsed: isAsideCollapsed }">
        <el-menu :default-active="activeMenu" router class="sidebar-menu" :collapse="isAsideCollapsed" :collapse-transition="false">
          ...
          <el-menu-item index="/teacher/change-requests">
            <el-icon><List /></el-icon>
            <template #title>变更申请</template>
          </el-menu-item>
          <el-menu-item index="/teacher/evaluation">
            <el-icon><Document /></el-icon>
            <template #title>选题质量</template>
          </el-menu-item>
          <el-menu-item index="/teacher/collab">
            <el-icon><Document /></el-icon>
...
.layout-aside.collapsed :deep(.el-menu-item:nth-child(7) .el-icon) {
